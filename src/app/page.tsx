...
export default function Home() {
  ...
  function continueLesson() {
    if (step < firstLesson.steps.length - 1) setStep(step + 1);
  ...
  return (
    <main className="app-shell">
      <aside className="sidebar">
        ...
        <nav>
          <div className="nav-title">FOUNDATIONS</div>
      ...
      <section className="content">
        ...
        <div className="lesson">
          ...
          <p className="subtitle">{firstLesson.subtitle}</p>
          ...
          <div className="teacher">
            ...
            <div className="bubble">
              <span className="speaker">Forsure</span>
              <p>{firstLesson.steps[step]}</p>
            </div>
          </div>
          ...
          <div className="visual">
            ...
            <div className="flow">
              <div className="thing">🎯<span>Goal</span></div>
              <ChevronRight />
              <div className="thing">🧩<span>Small steps</span></div>
              <ChevronRight />
              <div className="thing">🤖<span>Computer</span></div>
            </div>
          </div>
          ...
          <div className="challenge">
            ...
            <div className="options">
              {firstLesson.challenge.options.map(option =>
